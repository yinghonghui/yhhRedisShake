...
import (
	...
	"redis-shake/pkg/libs/atomic2"
	"redis-shake/pkg/libs/errors"
	"redis-shake/pkg/libs/log"
	"redis-shake/pkg/libs/stats"
	"redis-shake/pkg/rdb"
	"redis-shake/pkg/redis"
...
func DelRdbEntry(c redigo.Conn, e *rdb.BinEntry) {
	params := []interface{}{e.Key}
	_, _ = redigoCluster.String(c.Do("unlink", params...))
}
